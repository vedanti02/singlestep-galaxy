...
# GAN ablation: noz. See research_scratch_pad.md.
...
CKPT=/data/user_data/vkshirsa/singlestep_runs/pvfm_gan_noz/ckpt_latest.pt
RESUME_ARG=""
[[ -f "$CKPT" ]] && RESUME_ARG="--resume $CKPT" && echo "Resuming from $CKPT" >&2

python3 -u train.py --config config/gan_noz.yaml \
